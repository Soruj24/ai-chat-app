...
const getWeatherTool = () => {
    return new tools_1.DynamicStructuredTool({
        name: "weather",
        description: "Get current weather and forecast for a specific location. Input should be a city name (e.g., 'London', 'New York').",
        schema: zod_1.z.object({
            location: zod_1.z.string().describe("The city name to get weather for"),
        }),
        func: async ({ location }) => {
            try {
