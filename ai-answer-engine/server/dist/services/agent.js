...
const vector_1 = require("../tools/vector");
const mcp_1 = require("../tools/mcp");
const calculator_1 = require("../tools/calculator");
const academic_1 = require("../tools/academic");
...
const createChatAgent = async (sessionId, isResearchMode = false, modelName = "llama3.2", tone = "Neutral", focusMode = "web") => {
    ...
    if (focusMode === "academic") {
        ...
        tools = [(0, youtube_1.getYouTubeSearchTool)(), new scraper_1.WebScraperTool(), ...commonTools];
    }
